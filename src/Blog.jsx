                        ...
                        <div className="container">
                            <div className="blog-post" data-aos="zoom-in">
                                <div className="blog-content">
                                    <div className="div">
                                        <button className="buttom prew" onClick={incImg}><ChevronLeftIcon /></button>
                                        <img src={num}></img>
                                        <button className="buttom next" onClick={decImg}><ChevronRightIcon /></button>
                                    </div>
                            ...
                            <div className="popular-post">
                                ...
                                <div className="popular-tags">
                                    ...
                                    <div className="tags flex-row">
                                        ...
                                        <span className="tag" data-aos="flip-up" data-aos-delay="200">Techonlogy</span>
