            ...
            <footer className="footer">
                <div className="container">
                    <div className="about-us" data-aos="fade-right">
                        <h2>about us</h2>
                        <p>hey i'm a footer about us section for only design so don worrie and pleas stay away from me</p>
                    </div>
                    <div className="newsletter" data-aos="fade-right">
                        <h2>newsletter</h2>
                        <p>Stay update with our latest</p>
                        <div className="form-element">
                            <input type="text" placeholder="Email" /><span><NavigateNextIcon /></span>
                        </div>
                    </div>
                ...
                <a href="#" target="_black"> ArchNights <YouTubeIcon /></a>
                    </h4>
                </div>
            </footer>
        </>
